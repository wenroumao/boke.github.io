...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | wenroumao")[0];
}
...
__  _  __ ____   ___________  ____  __ __  _____ _____    ____  
\ \/ \/ // __ \ /    \_  __ \/  _ \|  |  \/     \\__  \  /  _ \ 
 \     /\  ___/|   |  \  | \(  <_> )  |  /  Y Y  \/ __ \(  <_> )
  \/\_/  \___  >___|  /__|   \____/|____/|__|_|  (____  /\____/ 
             \/     \/                         \/     \/        
`,
    "小站已经苟活",
    dnum,
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by wenroumao %c 你正在访问温柔猫の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 温柔猫") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('温柔猫的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function setFont(n) {
  ...
  if (n == "default") {
    ...
    document.body.style.fontFamily = "var(--global-font),-apple-system, IBM Plex Mono ,monosapce,'微软雅黑', sans-serif,mac";
  }
